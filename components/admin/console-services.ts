...
export const consoleServices: readonly ConsoleService[] = [
  ...
  { id: "cinema", title: "OnlineCinema", icon: Clapperboard, accent: "purple", group: "Commerce", href: "/console/cinema", label: "ENTERTAINMENT · WATCH", description: "Study and watch together.", detail: "Every collaborative room, the people in it, and the reports students raise.", action: "Open rooms", tags: ["Study rooms", "Watch reports"], nav: [{ label: "Rooms", href: "/console/cinema" }, { label: "Reports", href: "/console/cinema/signals" }] },
