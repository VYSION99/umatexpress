...
KEYS="ADMIN_EMAILS ADMIN_PASSWORD ADMIN_SESSION_SECRET CAMPUS_APP_URL CLOUDFLARE_ACCOUNT_ID CLOUDFLARE_AI_MODEL CLOUDFLARE_AI_TOKEN PAYMENT_PROVIDER PAYOUT_ENCRYPTION_KEY PAYSTACK_CURRENCY PAYSTACK_SECRET_KEY RESEND_API_KEY RESEND_FROM RESEND_REPLY_TO STUDENT_SESSION_SECRET TURSO_AUTH_TOKEN TURSO_DATABASE_URL"
